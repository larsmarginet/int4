        ...
        <main style={{ overflow: 'scroll', width: '100%', height: (height-80)}}>
            ...
            <div style={{zIndex: 6}} className={style.pigeonWrapper}>
                ...
                <Button
                    ...
                    height={43}
                    width={45}/>
                    <div className={style.textBalloonContent}><p>Hallo! Thierry hier. Je kan een kunstwerk ontgrendelen met je franken. <img className={style.frank} src='./assets/coin.svg' alt='frank' /> </p><p>Ik zal je doorheen hun verhalen leiden!</p></div>
                </div> : ""}
                <img style={{transform: 'scaleX(-1)', position: "absolute", right: 0, bottom: 0}} className={ pigeonText ? "" : style.glow } onClick={() => {
                    play()
                    setPigeonText(true)

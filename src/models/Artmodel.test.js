...
test('Create a piece of art', () => {
  const art = new ArtModel({pic: 'picture', name: 'art1', artist: 'artist1', price: 1000});
  expect(art.pic).toBe('picture');
...
test('Create levels', () => {
    ...
    const art = new ArtModel({pic: 'picture', name: 'art1', artist: 'artist1', levels: [level1, level2, level3], price: 1000});
